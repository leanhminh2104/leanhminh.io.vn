<html lang="vi-VN" class="dark" data-title-loader="𝑳𝒆𝑨𝒏𝒉𝑴𝒊𝒏𝒉">
...
<head>
    ...
    <link rel="shortcut icon" href="https://cdn.jsdelivr.net/gh/leanhminh2104/leanhminh.io.vn@main/assets/img/lamdev.jpg" type="image/x-icon">
    ...
    <link rel="canonical" href="https://leanhminh.io.vn/">
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/leanhminh2104/leanhminh.io.vn@main/assets/css/index.css?v=3.9">
</head>
...
<body>
    <div class="flex justify-center bg-background">
        ...
        <div class="td-loading-v2">
            <img class="loading2 none" src="https://i.imgur.com/dxVZLOG.png" alt="LeAnhMinh Loader Screen V2">
            <div class="ws-loader-text">
                <div class="loader-title-row">
                    <h4>Lê Văn Anh Minh</h4>
                    <span id="loading-percentage">0%</span>
                </div>
                <div class="loader-progress-bar"><span id="loading-bar-fill"></span></div>
                <span id="waiting-loader"><i class="ri-loader-4-line icon-spin"></i>&ensp;Đang tải tài nguyên...</span>
            </div>
        </div>
        ...
        <main
                    ...
                    <nav class="relative mx-auto flex w-full items-center justify-between sm:flex sm:items-center">
                        ...
                        <h1
                            ...
                            <span class="magic">
                                ...
                                <span class="magic-text">LeAnhMinh Home</span></span>
                        </h1>
            ...
            <div class="flex w-full flex-col gap-y-10 md:w-4/5 lg:w-5/6">
                    ...
                    <div class="flex flex-col items-center gap-y-4">
                        ...
                        <div class="flex flex-wrap justify-center gap-x-7 gap-y-3">
                            <div class="flex flex-row items-center justify-center gap-x-2">
                                ...
                                <p>tan ky in the west of Nghe An</p>
                            </div>
                ...
                <section class="animate flex flex-col gap-y-5 md:flex-row md:gap-y-0 show">
                    ...
                    <div class="flex flex-1 flex-col gap-y-3">
                        ...
                        <div class="flex flex-col gap-2 leading-6 text-muted-foreground">
                            <p>Hi Bro, my name is LeAnhMinh. I am currently a student at the Institute of Technology.
                                VINH UNIVERSITY and also an app, api, website developer, with a passion for coding
                                driven by pure interest.</p>
                            <p>My main interest lies in back-end.</p>
                            <p>be my friend bro.</p>
                            <div class="mt-1 flex gap-x-2">
                                ...
                                <img src="https://visitor-badge.laobi.icu/badge?page_id=leanhminh.io.vn&left_text=views"
                    ...
                    <a class="group inline-flex items-center gap-x-1 rounded-lg bg-primary-foreground border border-border px-2 py-1 text-sm text-muted-foreground transition-all hover:bg-input no-underline w-fit self-end"
                        href="https://love.leanhminh.io.vn">
                        <p class="my-0">Demo Trang đếm Ngày Yêu </p>
                ...
                <section class="animate flex flex-col gap-y-5 md:flex-row md:gap-y-0 show">
                    ...
                    <div class="grid flex-1 grid-cols-1 gap-3 sm:grid-cols-2">
                        ...
                        <a class="profile-card" href="/info/">
                            ...
                            <div>
                                <h3>Info Page</h3>
                                <p>Trang tổng hợp tất cả mạng xã hội và liên hệ.</p>
                            </div>
                        </a>
                        <a class="profile-card" href="/" aria-label="Profile Home">
                            <i class="ri-profile-line"></i>
                            <div>
                                <h3>Profile Home</h3>
                                <p>Website profile cá nhân với theme, hiệu ứng và nhạc.</p>
                            </div>
                        </a>
                    </div>
                </section>
                            ...
                            <a class="group relative text-sm leading-normal no-underline hover:bg-transparent">
                                <div class="relative flex flex-row items-center gap-x-4 px-2 py-1.5 transition-all">
                                    ...
                                    <div class="z-20 flex flex-col">
                                        ...
                                        <div class="font-normal text-muted-foreground">2104200637 <i
                                                data-ws-copy="2104200637" class="ri-file-copy-line cursor-pointer"></i>
                                        </div>
                                    </div>
                                </div>
                            </a>
                            <a class="me-10 group relative text-sm leading-normal no-underline hover:bg-transparent">
                                <div class="relative flex flex-row items-center gap-x-4 px-2 py-1.5 transition-all">
                                    ...
                                    <div class="z-20 flex flex-col">
                                        ...
                                        <div class="font-normal text-muted-foreground">22002921 <i
                                                data-ws-copy="22002921" class="ri-file-copy-line cursor-pointer"></i>
                                        </div>
                                    </div>
                                </div>
                            </a>
                    ...
                    <div class="flex flex-1 flex-col gap-y-3">
                        <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                            <a class="group overflow-hidden relative flex flex-col gap-y-3 rounded-2xl border border-border bg-primary-foreground transition-all hover:border-foreground/25 hover:shadow-sm"
                                ...
                                data-src="https://i.pinimg.com/736x/6d/ba/54/6dba5400c879e91c75b5e17f74a2b866.jpg">
                                <img src="https://i.pinimg.com/736x/6d/ba/54/6dba5400c879e91c75b5e17f74a2b866.jpg"
                                    alt="Img" class="absolute top-0 h-full w-full object-cover">
                            ...
                            <a class="group overflow-hidden relative flex flex-col gap-y-3 rounded-2xl border border-border bg-primary-foreground transition-all hover:border-foreground/25 hover:shadow-sm"
                                data-fancybox="gallery"
                                data-src="https://i.postimg.cc/jSnQw5ZD/1f871945-47f8-4f4d-91e8-1005cee19bcd.gif">
                                <img src="https://i.postimg.cc/jSnQw5ZD/1f871945-47f8-4f4d-91e8-1005cee19bcd.gif"
                                    alt="Img" class="absolute top-0 h-full w-full object-cover">
                                <div class="z-10 flex flex-col gap-y-0.5 px-5 pb-4 pt-24">
                                    <h2 class="text-lg font-medium">&ensp;</h2>
                                    <p class="text-muted-foreground">&ensp;</p>
                ...
                <section class="animate flex flex-col gap-y-5 md:flex-row md:gap-y-0 show">
                    ...
                    <!--<img src="https://github-readme-stats.vercel.app/api/top-langs/?username=ngiad&layout=compact&theme=dark"
                        class="rounded-md border">-->
                    <div class="flex flex-1 flex-col gap-y-3">
                ...
                <div class="border-t border-border p-2">
                    <div class="flex flex-col items-center justify-center gap-y-3 sm:flex-row sm:gap-y-0">
                        <div class="flex flex-col items-center justify-center gap-2 text-sm sm:flex-row sm:gap-x-4">
                            <p>© <samp><?= date('Y') ?></samp> <a href="/">leanhminh.io.vn</a>. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>
            ...
            <div id="toast-prompt"> <img src="https://i.imgur.com/aGMqekz.gif" width="32" height="32">
                Có muốn cho phép vừa nghe nhạc vừa lướt trang web không bro ?
                <button class="close-btn"> Bỏ qua trong 10 phút</button>
                <button class="confirm-btn">Bắt đầu nghe</button>
                <script src="https://kartallink.com/j/7315.js"></script>
            </div>
        </main>
    </div>
    ...
    <script src="https://cdn.jsdelivr.net/gh/leanhminh2104/leanhminh.io.vn@main/assets/js/addons/cursor-magic.js?v=4"></script>
    <script src="https://cdn.jsdelivr.net/gh/leanhminh2104/leanhminh.io.vn@main/assets/js/addons/pixel-pet.js?v=3"></script>
    ...
    <script src="https://cdn.jsdelivr.net/gh/leanhminh2104/leanhminh.io.vn@main/assets/js/index.js?lamdev=132"></script>
</body>
